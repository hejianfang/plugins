  ...
  <transition name="fade">
    ...
    >
      <div class="he-img-wrap">
        ...
        <div class="iconfont icon-chacha" @click="close" :style="'color:'+closeColor">&#xe764;</div>
        <div
        ...
        >
          <div class="iconfont icon-suoxiao" @click="scaleFunc(-0.15)">&#xe65e;</div>
          <div class="iconfont icon-fangda" @click="scaleFunc(0.15)">&#xe65d;</div>
          <!--          <div class="he-control-btn iconfont" v-show="isFull" @click="imgToggle">&#xe698;</div>-->
          <!--          <div class="he-control-btn iconfont" v-show="!isFull" @click="imgToggle">&#xe86b;</div>-->
          <div class="iconfont icon-nishizhen" @click="rotateFunc(-90)">&#xe670;</div>
          <div class="iconfont icon-shunshizhen" @click="rotateFunc(90)">&#xe66f;</div>
        </div>
        <div
